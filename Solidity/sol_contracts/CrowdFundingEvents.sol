...
contract CrowdfundingEvent
{
    ...
    {  
        ...
        require(msg.value >= crowdfunding_event_min_deposit, 'Contribution value less than the minimum contribution value set in the fundraiser');
        //flag to reject contributions not made in multiples of minimum value    
        require(msg.value % crowdfunding_event_min_deposit == 0, 'Contribution value not in multiples of the minimum contribution value set in the fundraiser');
